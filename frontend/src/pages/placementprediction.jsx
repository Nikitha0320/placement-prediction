...
function PlacementPrediction() {
  ...
  // SVG circular progress calculation (enlarged gauge)
  const radius = 80;
  const stroke = 10;
            ...
            <div className="result-flex-container">
              ...
              <div className="progress-ring-container">
                ...
                <div className="progress-ring-value">
                  <div style={{ fontSize: '1.35rem', fontWeight: 900, lineHeight: 1 }}>{formattedConfidence}%</div>
              ...
              <div className="result-main-info">
                ...
                {/* Feedback paragraph removed per user request */}
